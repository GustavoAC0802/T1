...
const listagem_1 = require("../negocio/listagem");
const cadastro_1 = require("../negocio/cadastro");
const cpf_1 = __importDefault(require("../modelo/cpf"));
console.log(`Bem-vindo ao cadastro de clientes do Grupo World Beauty`);
let empresa = new empresa_1.default();
let cadastroPS = new cadastro_1.CadastroProdutoServico(empresa);
cadastroPS.cadastrar();
let cadastroClientesAuto = new cadastro_1.CadastroClientesAuto(empresa);
...
while (execucao) {
    ...
    switch (opcao) {
        case 1:
            let cadastro = new cadastro_1.CadastroCliente(empresa.getClientes);
            cadastro.cadastrar();
            break;
        case 2:
            let listagem = new listagem_1.ListagemClientes(empresa.getClientes);
            listagem.listar();
            break;
        case 3:
            ...
            switch (opc) {
                case 1:
                    let listagem = new listagem_1.ListarTop10ClientesMaisConsumiramQuantidade(empresa);
                    listagem.listar();
                    break;
                case 2:
                    let listarGenero = new listagem_1.ListarClientesPorGenero(empresa.getClientes);
                    listarGenero.listar();
                    break;
                case 3:
                    let listarP = new listagem_1.ListarProdutosMaisConsumidos(empresa);
                    let listarS = new listagem_1.ListarServicosMaisConsumidos(empresa);
                    listarP.listar();
                    listarS.listar();
                    break;
                case 4:
                    ...
                    if (genero === 'M' || genero === 'F') {
                        new listagem_1.ListarTop10ClientesPorGenero(empresa, genero).listar();
                    }
                    else {
                    ...
                    break;
                case 5:
                    let listarT10 = new listagem_1.ListarTop10ClientesMenosConsumiram(empresa);
                    listarT10.listar();
                    break;
                case 6:
                    let ListarValor = new listagem_1.ListarTop5ClientesMaisConsumiramValor(empresa);
                    ListarValor.listar();
                    break;
            }
            break;
        ...
        case 4:
            ...
            switch (opc2) {
                case 1:
                    ...
                    const novoCpf = new cpf_1.default(novoNumeroCpf, novaDataEmissao);
                ...
                case 2:
                    ...
                    switch (opc3) {
                        case 1:
                            const novoProduto = new cadastro_1.CadastroProduto(empresa.getProdutos);
                ...
                case 3:
                    ...
                    switch (opc4) {
                        case 1:
                            const novoServico = new cadastro_1.CadastroProduto(empresa.getServicos); // mesma classe de Produto
